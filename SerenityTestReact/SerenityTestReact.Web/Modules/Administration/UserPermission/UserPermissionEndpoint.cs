using MyRepository = SerenityTestReact.Administration.Repositories.UserPermissionRepository;
using MyRow = SerenityTestReact.Administration.UserPermissionRow;
